...
describe("KQL grammar generation", () => {
  test("generates KQL-like grammar", () => {
    const config: GrammarGeneratorConfig = {
      ...
      astTypes: {
        ...
        operator: {
          ...
          grammarFields:
            "whereClause | projectClause | extendClause | sortClause | limitClause | takeClause | topClause | distinctClause | summarizeClause | joinClause | identifier | Number | String",
          isRule: true,
        },
        whereClause: {
        ...
        joinClause: {
          ...
          grammarFields:
            'kw<"join"> joinKind? tableExpression kw<"on"> expression',
          isRule: true,
        },
        joinKind: {
        ...
        aggregation: {
          ...
          grammarFields:
            "identifier Equals aggregateFunction | aggregateFunction",
          isRule: true,
        },
        aggregateFunction: {
    ...
    expect(result.grammar).toContain(
      'kw<"let"> identifier Equals expression Semicolon'
    );
