...
export const expressionRules: Record<string, RuleDef> = {
  ...
  RangeExpression: {
      expression: seq(ref("AdditiveExpression"), ref("RangeOp"), ref("AdditiveExpression"))
  },
  ...
  StringOp: {
      expression: choice(
          kw("contains"), ref("NotContains"),
          ref("ContainsCs"), ref("NotContainsCs"),
          kw("startswith"), ref("NotStartsWith"),
          ref("StartsWithCs"), ref("NotStartsWithCs"),
          kw("endswith"), ref("NotEndsWith"),
          ref("EndsWithCs"), ref("NotEndsWithCs"),
          kw("has"), ref("NotHas"),
          ref("HasCs"), ref("NotHasCs"),
          kw("hasprefix"), ref("NotHasPrefix"),
          kw("hassuffix"), ref("NotHasSuffix"),
          kw("in"), ref("NotIn"),
          ref("InCs"), ref("NotInCs"),
          kw("matches"), kw("regex")
      )
  },
  ...
  PrimaryExpression: {
    expression: choice(
      ...
      ref("FunctionCall"),
      choice(ref("Identifier"), ref("BracketedIdentifier"), ref("Number"), ref("String"), kw("true"), kw("false"), kw("null"))
    ),
  },
