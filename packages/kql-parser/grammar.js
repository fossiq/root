module.exports = grammar({
  ...
  rules: {
    ...
    operator: ($) => choice($.where_clause, $.project_clause, $.project_away_clause, $.project_keep_clause, $.project_rename_clause, $.project_reorder_clause, $.extend_clause, $.summarize_clause, $.join_clause, $.union_clause, $.parse_clause, $.mv_expand_clause, $.take_clause, $.limit_clause, $.sort_clause, $.order_clause, $.distinct_clause, $.count_clause, $.top_clause, $.search_clause),
    table_name: ($) => $.identifier,
    where_clause: ($) => prec.left(seq("where", $.expression)),
    project_clause: ($) => seq("project", $.column_list),
    project_away_clause: ($) => seq(choice("project-away", "projectaway"), $.column_list),
    project_keep_clause: ($) => seq(choice("project-keep", "projectkeep"), $.column_list),
    project_rename_clause: ($) => seq(choice("project-rename", "projectrename"), $.column_list),
    project_reorder_clause: ($) => seq(choice("project-reorder", "projectreorder"), $.column_list),
    ...
    between_expression: ($) => prec.left(2, seq($.identifier, "between", "(", $.between_value, "..", $.between_value, ")")),
    between_value: ($) => choice($.literal, $.function_call),
    ...
    identifier: ($) => choice(/[a-zA-Z_][a-zA-Z0-9_]*/, prec(1, seq("[", $.string_literal, "]"))),
