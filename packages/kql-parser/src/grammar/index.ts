...
export function createGrammar(): GrammarConfig {
  ...
  return {
    ...
    rules: {
      ...
      project_away_clause: rules.projectAwayClause($),
      project_keep_clause: rules.projectKeepClause($),
      project_rename_clause: rules.projectRenameClause($),
      project_reorder_clause: rules.projectReorderClause($),
