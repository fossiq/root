...
describe("Expressions", () => {
  test("binary and expression", async () => {
    const result = await parseWithTreeSitter(
      'Users | where age > 18 and country == "US"'
    );
  ...
  test("binary or expression", async () => {
    const result = await parseWithTreeSitter(
      "Users | where age > 18 or retired == true"
    );
    expect(result.success).toBe(true);
  });
  ...
  test("arithmetic expression", async () => {
    const result = await parseWithTreeSitter(
      "Users | extend total = price * quantity"
    );
    expect(result.success).toBe(true);
  });
  ...
  test("iff expression", async () => {
    const result = await parseWithTreeSitter(
      'Users | extend status = iff(age > 18, "adult", "minor")'
    );
    expect(result.success).toBe(true);
  });
  ...
  test("case expression", async () => {
    const result = await parseWithTreeSitter(
      'Users | extend level = case(score > 90, "A", score > 80, "B", "C")'
    );
    expect(result.success).toBe(true);
  });
  ...
  test("type cast double colon", async () => {
    const result = await parseWithTreeSitter(
      "Users | extend age_str = age::string"
    );
    expect(result.success).toBe(true);
  });
...
describe("Function calls", () => {
  test("simple function", async () => {
    const result = await parseWithTreeSitter(
      "Users | extend upper_name = toupper(name)"
    );
    expect(result.success).toBe(true);
  });
  ...
  test("multiple arguments", async () => {
    const result = await parseWithTreeSitter(
      "Users | extend full = strcat(first, last)"
    );
    expect(result.success).toBe(true);
  });
  ...
  test("nested functions", async () => {
    const result = await parseWithTreeSitter(
      "Users | extend result = toupper(substring(name, 0, 5))"
    );
    expect(result.success).toBe(true);
  });
  ...
  test("named arguments", async () => {
    const result = await parseWithTreeSitter(
      "Users | extend result = substring(text, start=0, length=5)"
    );
    expect(result.success).toBe(true);
  });
  ...
  test("mixed arguments", async () => {
    const result = await parseWithTreeSitter(
      'Users | extend formatted = strcat(first, last, separator=" ")'
    );
    expect(result.success).toBe(true);
  });
});
...
describe("Literals", () => {
  ...
  test("dynamic array", async () => {
    const result = await parseWithTreeSitter(
      "Users | extend items = dynamic([1, 2, 3])"
    );
    expect(result.success).toBe(true);
  });
  ...
  test("timespan minutes", async () => {
    const result = await parseWithTreeSitter(
      "Users | where timestamp > ago(30m)"
    );
    expect(result.success).toBe(true);
  });

  test("timespan milliseconds", async () => {
    const result = await parseWithTreeSitter(
      "Users | where timestamp > ago(500ms)"
    );
    expect(result.success).toBe(true);
  });
  ...
  test("datetime function", async () => {
    const result = await parseWithTreeSitter(
      'Users | where timestamp > datetime("2023-12-07")'
    );
    expect(result.success).toBe(true);
  });

  test("datetime ISO 8601 format with time", async () => {
    const result = await parseWithTreeSitter(
      'Users | where CreatedAt > datetime("2023-12-07T15:30:45Z")'
    );
    expect(result.success).toBe(true);
  });

  test("datetime function with null", async () => {
    const result = await parseWithTreeSitter(
      "Users | where CreatedAt == datetime(null)"
    );
    expect(result.success).toBe(true);
  });

  test("datetime now function", async () => {
    const result = await parseWithTreeSitter("Users | where CreatedAt > now()");
    expect(result.success).toBe(true);
  });

  test("datetime ago function", async () => {
    const result = await parseWithTreeSitter(
      "Users | where CreatedAt > ago(7d)"
    );
    expect(result.success).toBe(true);
  });
});
...
describe("Let statements", () => {
  ...
  test("let with string", async () => {
    const result = await parseWithTreeSitter(
      'let name = "John"; Users | where username == name'
    );
    expect(result.success).toBe(true);
  });
  ...
  test("multiple let statements", async () => {
    const result = await parseWithTreeSitter(
      "let a = 1; let b = 2; Users | extend sum = a + b"
    );
    expect(result.success).toBe(true);
  });
});
...
describe("Complex queries", () => {
  test("multiple pipes", async () => {
    const result = await parseWithTreeSitter(
      "Users | where age > 18 | project name, email | take 10"
    );
    expect(result.success).toBe(true);
  });
  ...
  test("complex where with parentheses", async () => {
    const result = await parseWithTreeSitter(
      'Users | where age > 18 and (country == "US" or country == "UK")'
    );
    expect(result.success).toBe(true);
  });
